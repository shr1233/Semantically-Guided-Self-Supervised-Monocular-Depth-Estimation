...
DEFAULT_DEPTH_BATCH_SIZE = 4
DEFAULT_SEG_BATCH_SIZE = 4
...
class ArgumentsBase(object):
    ...
    def _harness_init_depth(self):
        self.ap.add_argument(
            '--depth-validation-resize-height', type=int, default=128,
            help='Depth images are resized to this height'
        )

        self.ap.add_argument(
            '--depth-validation-resize-width', type=int, default=416,
            help='Depth images are resized to this width'
        )

        self.ap.add_argument(
            '--depth-validation-crop-height', type=int, default=128,
            help='Segmentation validation images are cropped to this height'
        )

        self.ap.add_argument(
            '--depth-validation-crop-width', type=int, default=416,
    ...
    def _harness_init_pose(self):
        self.ap.add_argument(
            '--pose-validation-resize-height', type=int, default=128,
            help='Depth images are resized to this height'
        )

        self.ap.add_argument(
            '--pose-validation-resize-width', type=int, default=416,
            help='Depth images are resized to this width'
        )
    ...
    def _training_init_depth(self):
        ...
        self.ap.add_argument(
            '--depth-resize-height', type=int, default=128,
            help='Depth images are resized to this height'
        )

        self.ap.add_argument(
            '--depth-resize-width', type=int, default=416,
            help='Depth images are resized to this width'
        )

        self.ap.add_argument(
            '--depth-crop-height', type=int, default=128,
            help='Segmentation images are cropped to this height'
        )

        self.ap.add_argument(
            '--depth-crop-width', type=int, default=416,
    ...
    def _training_init_segmentation(self):
        ...
        self.ap.add_argument(
            '--segmentation-crop-height', type=int, default=128,
            help='Segmentation images are cropped to this height'
        )

        self.ap.add_argument(
            '--segmentation-crop-width', type=int, default=416,
            help='Segmentation images are cropped to this width'
        )
    ...
    def _eval_init_logging(self):
        self.ap.add_argument(
            '--eval-num-images', type=int, default=600,
    ...
    def _inference(self):
        ...
        self.ap.add_argument(
            '--inference-resize-height', type=int, default=128,
            help='Segmentation images are resized to this height'
        )

        self.ap.add_argument(
            '--inference-resize-width', type=int, default=416,
